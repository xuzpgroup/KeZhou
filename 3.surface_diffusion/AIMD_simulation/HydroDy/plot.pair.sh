...
set ylabel 'OH intra. distribution'
set xrange [0.9:1.2]
set xtics  0.1
set ytics  0.04
p 'density.pair.profile.dat' u (\$1):(\$2) \
 w l lw 4 lc rgb 'blue' lt 1  title '',\
 


set ylabel 'OH inter. distribution'
set xrange [0.9:3.0]
set xtics  0.5
set ytics  0.01
p 'density.pair.profile.dat' u (\$1):(\$3) \
 w l lw 4 lc rgb 'blue' lt 1  title '',\
 



set ylabel 'OO inter. distribution'
set xrange [2.0:4.0]
set xtics  0.5
set ytics  0.01
p 'density.pair.profile.dat' u (\$1):(\$4) \
 w l lw 4 lc rgb 'blue' lt 1  title '',\
