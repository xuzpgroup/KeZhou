...
#set title "Time ${t} ps"
set output 'Density.profile.AIMD.eps'
...
p 'density.profile.dat' u (\$1*.1-0.6):(\$2/1000) \
 w filledcurves lw 4 lc rgb '#006699' lt 1  title 'water',\
'density.profile.dat' u (\$1*.1-0.6):(\$3*-10) \
 w l lw 4 lc rgb 'red' lt 1  title 'O',\
'density.profile.dat' u (\$1*.1-0.6):(\$4*-10) \
 w l lw 4 lc rgb 'blue' lt 1  title 'H',\
