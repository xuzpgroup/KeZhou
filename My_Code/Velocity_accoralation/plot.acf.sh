...
p '0vacf.data' u (\$1*1000):(\$2) w lp pt 2 lw 2 lc 1 lt 1  title 'x',\
'0vacf.data' u (\$1*1000):(\$3) w lp pt 2 lw 2 lc 2 lt 1  title 'y',\
'0vacf.data' u (\$1*1000):(\$4) w lp pt 2 lw 2 lc 3 lt 1  title 'z',\
'0vacf.data' u (\$1*1000):(\$5) w lp pt 6 lw 2 lc 4 lt 1  title 'xy',\
