...
'${path_G}' u (\$1*1):(\$2)  w l ls 21 lw 4 dt 3 title '',\
'${path_G}' u (\$1*1):(\$5)  w l ls 12 lw 4 dt 3 title '',\
'${path_G}' u (\$1*1):(\$3)  w l ls 13 lw 4 dt 3 title '',\
'${path_G}' u (\$1*1):(\$4)  w l ls 14 lw 4 dt 3 title '',\
...
file="DOS.Int.C"
# convert -density 500 ${file}.eps ${file}.Fe.png 
