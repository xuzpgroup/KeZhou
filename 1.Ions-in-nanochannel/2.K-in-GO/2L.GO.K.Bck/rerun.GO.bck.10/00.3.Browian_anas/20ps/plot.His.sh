...
set multiplot layout 1,1 title "interval 20 ps"
...
0.755529*exp(-x*x/1.99391) w l lt 1 lc 1 lw 2  title 'Gauss fit',\
'His.Lt.20ps.dat' u (\$3):(\$4) w p pt 7 ps 1 lw 1 lc 2 lt 1  title 'dy',\
0.721742*exp(-x*x/2.24498) w l lt 1 lc 2 lw 2  title 'Gauss fit'
