...
#set title "Time ${t} ps"
set output 'Capture.Time.CF.png'
...
# p '0ctcf.data' u (\$1):(\$2) w lp pt 2 lw 2 lc 1 lt 1  title 'x'

# p '01_norm_rtcf.data' u (\$1):(\$2) w lp pt 6 lw 2 lc 1 lt 1  title ''

p '01_norm_rtcf.data' u (\$1):(\$2) w l lw 2 lc 1 lt 1  title '',\
exp(-x/166.407) w l lt 1 lc 2 lw 2  title "",\
