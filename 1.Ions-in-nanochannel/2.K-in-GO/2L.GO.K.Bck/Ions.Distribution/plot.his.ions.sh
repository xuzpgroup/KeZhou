...
p './1_Distribution.GO.10.0/Water.distribution.data' u (\$1):(\$2) w l lw 2 lc 1 lt 1  title 'O atom',\
'./His.ions.z.dat' u (\$1):(\$2) w l lw 2 lc 2 lt 1  title 'ions',\
